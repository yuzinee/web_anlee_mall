			...
			<nav class="sb-sidenav accordion sb-sidenav-dark"
				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<a class="nav-link" id="" onclick="nav_control('manage_product_info')" style="margin-left:10px">조회/수정</a>
						<a class="nav-link" id="" onclick="nav_control('manage_product_detail')" style="margin-left:10px">신규등록</a>
					</div>
					<div class="nav">
